...
namespace Units.Movement.Cat
{
    ...
    public class WaitForFishSpawn : MovementState
    {
        ...
        public override void Start()
        {
            ...
            {
                StateMachine.TryChangeState<ChaiseForFishState>();
            }
    ...
    /// Chasing the Fish.
    /// </summary>
    public class ChaiseForFishState : MovementState
    {
        ...
        public ChaiseForFishState(IStateMachine stateMachine, IFishThief thief, float speed, float takeFishRange) : base(stateMachine)
        {
            _thief = thief;
    ...
    public class CatMovementStateMachine : MonoBehaviour, IStateMachine
    {
        ...
        private void Start()
        {
            ...
            States = new MovementState[]
            {
                ...
                new ChaiseForFishState(this, _cat, _pilferSpeed, _takeFishRange),
